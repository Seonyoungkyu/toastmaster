...
fun bindStartButtonImage(imageView: ImageButton, state: TimerState) {
    if (state is TimerState.Initialized) imageView.setImageResource(R.drawable.ic_action_start)
    else if (state.paused) imageView.setImageResource(R.drawable.ic_action_start)
